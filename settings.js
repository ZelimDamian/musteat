...
function bootApplication(app, config, passport) {
  ...
  app.configure(function () {
    ...
    app.use(function (req, res, next) {
      res.locals.appName = 'Кушать на!ДОM!'
      res.locals.title = 'Кушать на!ДОM!'
      ...
      res.locals.createPagination = function (pages, page) {
        ...
        str += '<li class="'+clas+'"><a href="?'+qs.stringify(params)+'">Первая</a></li>'
        ...
        str += '<li class="'+clas+'"><a href="?'+qs.stringify(params)+'">Последняя</a></li>'
